...
if ( ! class_exists( 'YPOP_Icon' ) ) {
    ...
    class YPOP_Icon {
        ...
        public function __construct() {
            ...
            $this->_icon_font_folder_url  = YITH_YPOP_ASSETS_URL . '/fonts';
            $this->_icon_font_folder_path = YITH_YPOP_ASSETS_PATH . '/fonts';
        ...
        public function enqueue_styles(){
            ...
            foreach( $this->_icon as $value ){
                ...
                if( file_exists( $font_style ) && ! function_exists( 'YITH_Icon' )  ){
            ...
            if ( ! class_exists( 'YIT_Asset' ) ){
                ...
                wp_enqueue_style( $css_prefix . 'font-awesome', YITH_YPOP_ASSETS_URL . '/css/font-awesome.min.css' );
